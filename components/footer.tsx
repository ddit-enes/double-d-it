  ...
  return (
    <footer className="relative z-10 pt-16 md:pt-20 lg:pt-24">
      <div className="container mx-auto px-4">
        <div className="mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-12 lg:mb-16">
              <h2 className="mb-10 text-lg font-bold">Useful Links</h2>
              <ul>
                <li>
                  <Link
                    href="/career"
                    className="mb-4 inline-block duration-300 hover:text-primary"
                  >
                    Career
                  </Link>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-12 lg:mb-16">
              <h2 className="mb-10 text-lg font-bold">Terms</h2>
              <ul>
                <li>
                  <Link
                    href="/privacy-policy"
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-12 lg:mb-16">
              <h2 className="mb-10 text-lg font-bold">Support & Help</h2>
              <ul>
                <li>
                  <Link
                    href="/contact"
                ...
                <li>
                  <Link href="/about" className="mb-4 inline-block duration-300 hover:text-primary">
                    About
                  </Link>
                </li>
              </ul>
        ...
        <Divider />
        <div className="py-4">
          <p className="text-center">{`© Copyright 2001-${year} - double D IT – IT-Concepts & Consulting Berlin`}</p>
        </div>
      </div>
