    ...
    <div className="relative">
      <address className="space-y-8">
        <div>
          ...
          <p>
            Email:{" "}
            <a href="mailto:info@double-d-it.de" className="underline">
              info@double-d-it.de
            </a>
          </p>
        </div>
        <Button className="px-12 py-6 shadow-none text-base w-full md:w-auto">Call now</Button>
      </address>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop offset="0.328125" stopColor={primaryColorHEX} />
                <stop offset="1" stopColor={primaryColorHEX} stopOpacity="0" />
              </linearGradient>
              <linearGradient
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="doube D IT" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="+491234567890" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
