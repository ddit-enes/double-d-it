    ...
    <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
      ...
      >
        ...
        <defs>
          ...
          >
            <stop offset="0.145833" stopColor={primaryColorHEX} stopOpacity="0" />
            <stop offset="1" stopColor={primaryColorHEX} stopOpacity="0.08" />
          </radialGradient>
          <radialGradient
      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <stop offset="1" stopColor={primaryColorHEX} />
          </linearGradient>
          <linearGradient
